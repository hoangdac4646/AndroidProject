package com.example.root.minigame.Suduku;
...
public class Soduku_Activity extends AppCompatActivity implements CellGroupFragment.OnFragmentInteractionListener {
    int CountTime =0;
    ImageView Finnish,DauHang,TamDung,AmThanh;
    EditText Content;
    Button Gui;
    ...
    List<GuiTinNhan> guiTinNhans = new ArrayList<>();
        int DemChoiLai=0;
    ...
    public void RandomIndexFileAndFileID(){
        ...
        Finnish = findViewById(R.id.img_finish);
            Main.click_button = new Click_button(Soduku_Activity.this);
        DauHang = findViewById(R.id.img_dauhang);
        TamDung = findViewById(R.id.img_pause);
        AmThanh = findViewById(R.id.img_amthanh);
        Chat = findViewById(R.id.lv_SogukuChat);
        Timer = findViewById(R.id.tv_timer);
        Gui = findViewById(R.id.btn_SogukuGui);
        Content = findViewById(R.id.edt_sogukuContent);
        adapter_listview = new Adapter_listview(Soduku_Activity.this,R.layout.custom_listview,guiTinNhans);
            ...
            switch (msg.what) {
                case Messages.MESSAGE_STATE_CHANGE:
                    if (msg.arg1 != BluetoothConnectionService.STATE_CONNECTED){
                        Toast.makeText(Soduku_Activity.this, "Bạn Đã Bị Mất Kết Nối!!", Toast.LENGTH_SHORT).show();
                    }
                    break;
                ...
                case Messages.MESSAGE_READ:
                    ...
                    if(readMessage.indexOf("-1")!=-1){
                        ...
                        guiTinNhans.add(new GuiTinNhan(stringBuilder.toString(),"Đối thủ"));
                        adapter_listview.notifyDataSetChanged();
                    }
                    else {
                        ...
                        if (readMessage.toString().equals("Finish")) {
                            ...
                            Toast.makeText(Soduku_Activity.this, "You lose ! ", Toast.LENGTH_SHORT).show();
                        }

                        //Dau thu dau hang
                        else if (readMessage.toString().equals("Giveup")) {
                            countDownTimer.cancel();
                            Toast.makeText(Soduku_Activity.this, "You win ! ", Toast.LENGTH_SHORT).show();
                        }
                        //Tam dung 5s
                        else if(readMessage.toString().equals("pause")){
                            final Dialog dialog = new Dialog(Soduku_Activity.this);
                            ...
                            Toast.makeText(Soduku_Activity.this, "Đối thủ đã thoát ! ", Toast.LENGTH_SHORT).show();
                            startActivity(new Intent(Soduku_Activity.this,StartingMenu.class));
                        }else if(readMessage.equals("ChoiMoi")){
                            AlertDialog.Builder builder = new AlertDialog.Builder(Soduku_Activity.this);
                            ...
                            builder.setPositiveButton("Có", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    Toast.makeText(Soduku_Activity.this, "Choi moi ne haha", Toast.LENGTH_SHORT).show();
                            ...
                            Toast.makeText(Soduku_Activity.this, "Choi moi ne", Toast.LENGTH_SHORT).show();
                            StringBuilder stringBuilder1  =new StringBuilder();
                            for(int i=2;i<readMessage.length();i++){
                                stringBuilder1.append(readMessage.charAt(i));
                            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.soguku_main);
        Init();

        //Load nhac
        stopService(Main.NhacCho);
        mediaPlayer = MediaPlayer.create(Soduku_Activity.this,R.raw.nhacnen2);
             ...
             public void onClick(View v) {
                 Main.click_button.PlayButtonSound();
                    if(onKiemTraDung(v) ==true){
                        ...
                        Toast.makeText(Soduku_Activity.this, "Sai dap an !", Toast.LENGTH_SHORT).show();
                    }
             }
         });
        ...
        Gui.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                guiTinNhans.add(new GuiTinNhan(Content.getText().toString(),"Me"));
                adapter_listview.notifyDataSetChanged();
                Content.setText("");
            }
        });
